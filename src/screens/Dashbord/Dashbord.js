                ...
                <div className="card">
                  ...
                  <div className="body">
                    ...
                    >
                      ...
                      <div className="msg">
                        <p>
                          Weldone! You have completed the Rubix registration and are now one step closer
                          to being part of our ground breaking team.
              ...
              {/* <div className="col-lg-3 col-md-6">
                <div className="card">
                  ...
                  <div className="body text-center">
                    <h4 className="margin-0">Total Time</h4>
                    <div
                      id="topsaleDonut"
                    ...
                    />
                    <h6 className="p-b-15">Weekly Time Spent</h6>
