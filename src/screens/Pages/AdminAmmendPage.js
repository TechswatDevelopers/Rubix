    ...
    this.props.updateLoadingController(true);
      this.props.updateLoadingMessage("Loading Residence Details, Please wait...");
        ...
        const postData = async () => {
          await axios.post('https://jjprest.rubix.mobi:88/api/RubixAdminGetLeaseRefferenceList', data, requestOptions)
            .then(response => {
              //Sort out the data
...
//Get Specific User Data
  updateLeaseData(){
    ...
    const postData = async () => {
      await axios.post('https://jjprest.rubix.mobi:88/api/RubixAdminAddLeaseRefferance', data, requestOptions)
        .then(response => {
        })
    }
    postData()
  ...
  loadStudentsList(){
    ...
    const postData = async () => {
      await axios.post('https://jjprest.rubix.mobi:88/api/RubixAdminRateUpdateData', data, requestOptions)
        .then(response => {
          this.setState({
...
//Mass Ammend Lease 
  bulkUpdateLeaseData(){ 
    ...
    const postData = async () => {
      await axios.post('https://jjprest.rubix.mobi:88/api/RubixAdminAddLeaseBulkUpdate', data, requestOptions)
        .then(response => {
