...
class Students extends React.Component {
  ...
  bulkLease(e){
    ...
    const postData = async () => {
      await axios.post('https://adowarest.rubix.mobi:88/api/RubixAdminLeaseBulkUpdate', pingData, requestOptions)
      .then(response => {
...
//console.log("the current student is: ", this.state.studentLeaseAmmend)
  ...
  const data = {
    "PDFDocumentUrl" :"https://adowaimages.rubix.mobi:449/" + student.FileName,
