      ...
      myBody = <> {this.state.doc != null 
        ...
        <Tab eventKey="signing" title="Lease Agreement">
          <div className="w-auto p-3">
            ...
            <iframe /* sandbox="allow-pointer-lock" */ style= {localStorage.getItem('role') == 'admin'?{} :{pointerEvents: 'none', overflow: 'scroll',}} src={'https://adowaimages.rubix.mobi:449/' + this.state.myLease} width="100%" height="800px" >
           </iframe>
           </div>
