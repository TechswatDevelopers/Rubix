...
class RubixTickets extends React.Component {
    ...
    getTockets(){
      ...
      const postData = async () => {
        await axios.post('http://129.232.144.154:88/api/RubixGetSupportData', data, requestOptions)
        .then(response => {
  ...
  const postData = async()=>{
    await axios.post('http://129.232.144.154:88/api/RubixSupportUpdate', data, requestOptions)
    .then(response => {
